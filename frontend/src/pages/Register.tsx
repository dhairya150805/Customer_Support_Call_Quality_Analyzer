...
import { BrainCircuit, Building2, Mail, Lock, Loader2, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="chart-card">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Start analyzing your call centre data today
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Email */}
            <div>
              <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Company Email</label>
              <div className="relative">
